        ...
        <Form onSubmit={handleSubmit}>
          <div className="d-flex mx-auto flex-column mt-5 mb-5 " >
            <div className="">
              ...
              <div className="rowMain text-center mt-3">
              ...
              <Table striped bordered className="rowMain text-center tableInput">
                <thead>
                  <tr className="text-center">
                    <th>No.</th>
                ...
                <tbody>
                  <tr>
                    <td className="my-auto" rowSpan={2}>1</td>
                    <td colSpan={4}>Toyobo Fodu Premium Quality</td>
                    <td colSpan={2}>Merah Maroon Tua</td>
                    <td colSpan={3}>gamis</td>
                    <td colSpan={3}>midi</td>
                    <td colSpan={2}>Rp. 10.0000</td>
